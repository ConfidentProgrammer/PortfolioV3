  ...
  return <div className='about-container'>
      <div className="container">
         <div className="row">
            ...
            <span className='diff-text'>01.</span>  About <hr className='about-line' />
          </h2>
          <Tag name='/h2' />
          <Tag name='p' />
             ...
             <div className="skills-div">
              <ul className='skills-ul'>
                  <li className="skills-li"><i class="fas fa-angle-right"></i> Javascript</li>
                  <li className="skills-li"><i class="fas fa-angle-right"></i> React</li>
                  <li className="skills-li"><i class="fas fa-angle-right"></i> Java</li>
              </ul>
              <ul className='skills-ul'>
                  <li className="skills-li"><i class="fas fa-angle-right"></i> REST</li>
                  <li className="skills-li"><i class="fas fa-angle-right"></i> CSS3 (Sass)</li>
                  <li className="skills-li"><i class="fas fa-angle-right"></i> Figma</li>
              </ul>
              </div>
             </p>
             <Tag name='/p' />
